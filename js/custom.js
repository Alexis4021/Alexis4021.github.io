...
links.forEach(link => link.addEventListener('click', function (e) {
    ...
    if (document.querySelector(page)) {
        ...
        function transitionblock() {
            ...
            // reiniciar animación previa
            breaker.classList.remove('animate');
            void breaker.offsetWidth; // forzar reflow

            // mostrar bloque
            breaker.style.display = 'block';

            // iniciar animación
            breaker.classList.add('animate');

            // ocultar cuando termine
            breaker.addEventListener('animationend', function hide() {
                breaker.style.display = 'none';
                breaker.classList.remove('animate');
                breaker.removeEventListener('animationend', hide);
            });
        }
